...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div id="perawatan_table" style="margin-top: 10em;" class="col-md-12">
                ...
                <div align="left">
                    ...
                    type="button" 
                    data-toggle="modal" 
                    data-target="#add_data_perawatan" 
                ...
                <table class="table">
                    ...
                    include "koneksi.php";
                    $id = 1;
                    $query = mysqli_query($kon, 'SELECT * FROM jenis_perawatan');
            ...
            <div id="add_data_perawatan" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h4 class="modal-title">Tambahkan data perawatan mobil yang disewa</h4>
    ...
    $query = "
    INSERT INTO jenis_perawatan(nama)  
     VALUES('$nama')
    ";
    if(mysqli_query($connect, $query))
    {
    $output .= '<label class="text-success">Data Berhasil Masuk</label>';
    $select_query = "SELECT * FROM jenis_perawatan ORDER BY id DESC";
...
<script>
    ...
    $('#insert_form').on("click", function(event){  
        ...
        $.ajax({  
            ...
            $('#insert_form')[0].reset();  
            $('#add_data_perawatan').modal('hide');  
            $('#perawatan_table').html(data);  
            }  
        });  
    }  
    });
