...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div id="merk_table" style="margin-top: 10em;" class="col-md-12">
                ...
                <table class="table">
                    ...
                    include "koneksi.php";
                    $id = 1;
                    $query = mysqli_query($kon, 'SELECT * FROM merk');
    ...
    <div id="add_data_merk" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title">Tambahkan data merk mobil untuk disewa</h4>
    ...
    $query = "
    INSERT INTO merk(nama, produk)  
     VALUES('$nama', '$produk')
    ";
    if(mysqli_query($connect, $query))
    {
    $output .= '<label class="text-success">Data Berhasil Masuk</label>';
    $select_query = "SELECT * FROM merk ORDER BY id DESC";
  ...
  <div class="copyright_section">
   ...
   <script>
    ...
    $('#insert_form').on("click", function(event){  
        ...
        if($('#nama').val() == "")  
        {  
        alert("Mohon Isi Nama Merk Kendaraan ");  
        }  
        else if($('#produk').val() == '')  
        {  
        alert("Mohon Isi Produk");  
        }  
        else 
        {  
        $.ajax({  
            ...
            $('#insert_form')[0].reset();  
            $('#add_data_merk').modal('hide');  
            $('#merk_table').html(data);  
            }  
        });  
        }  
        });
